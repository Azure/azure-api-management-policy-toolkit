...
{
    public CompilationResultAssertion(ICompilationResult value, AssertionChain assertionChain) : base(value,
        assertionChain)
    {
    }
    ...
    public AndConstraint<CompilationResultAssertion> BeSuccessful(string because = "", params object[] becauseArgs)
    {
        ...
        this.CurrentAssertionChain.BecauseOf(because, becauseArgs);
        this.NotBeNull();
