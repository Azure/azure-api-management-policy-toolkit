...
public class LlmTokenLimitTests
{
    ...
    [DataRow(
        ...
        <policies>
            <inbound>
                <llm-token-limit counter-key="counter-key" estimate-prompt-token="false" tokens-per-minute="5000" />
            </inbound>
        </policies>
        """,
    ...
    [DataRow(
        ...
        <policies>
            <inbound>
                <llm-token-limit counter-key="user-token-counter" estimate-prompt-token="true" token-quota="10000" token-quota-period="Hourly" />
            </inbound>
        </policies>
        """,
    ...
    [DataRow(
        ...
        <policies>
            <inbound>
                <llm-token-limit counter-key="@(context.User.Id + "-token-counter")" estimate-prompt-token="true" tokens-per-minute="5000" />
            </inbound>
        </policies>
        """,
    ...
    [DataRow(
        ...
        <policies>
            <inbound>
                <llm-token-limit counter-key="counter-key" estimate-prompt-token="@(context.Request.Headers.ContainsKey("X-Estimate-Tokens"))" tokens-per-minute="5000" />
            </inbound>
        </policies>
        """,
        DisplayName = "Should compile llm-token-limit policy with expression in estimate-prompt-token"
    )]
    [DataRow(
        """
        [Document]
        ...
        <policies>
            <inbound>
                <llm-token-limit counter-key="counter-key" estimate-prompt-token="true" tokens-per-minute="@(context.User.Groups.Contains("premium") ? 10000 : 5000)" />
            </inbound>
        </policies>
        """,
    ...
    [DataRow(
        ...
        <policies>
            <inbound>
                <llm-token-limit counter-key="counter-key" estimate-prompt-token="true" token-quota="@(context.User.Groups.Contains("premium") ? 50000 : 20000)" token-quota-period="Daily" />
            </inbound>
        </policies>
        """,
    ...
    [DataRow(
        ...
        <policies>
            <inbound>
                <llm-token-limit counter-key="counter-key" estimate-prompt-token="true" tokens-per-minute="5000" retry-after-header-name="X-Retry-After" retry-after-variable-name="retryAfter" />
            </inbound>
        </policies>
        """,
    ...
    [DataRow(
        ...
        <policies>
            <inbound>
                <llm-token-limit counter-key="counter-key" estimate-prompt-token="true" token-quota="10000" token-quota-period="Hourly" remaining-quota-tokens-header-name="X-Remaining-Quota-Tokens" remaining-quota-tokens-variable-name="remainingQuotaTokens" />
            </inbound>
        </policies>
        """,
    ...
    [DataRow(
        ...
        <policies>
            <inbound>
                <llm-token-limit counter-key="counter-key" estimate-prompt-token="true" tokens-per-minute="5000" remaining-tokens-header-name="X-Remaining-Tokens" remaining-tokens-variable-name="remainingTokens" />
            </inbound>
        </policies>
        """,
    ...
    [DataRow(
        ...
        <policies>
            <inbound>
                <llm-token-limit counter-key="counter-key" estimate-prompt-token="true" tokens-per-minute="5000" tokens-consumed-header-name="X-Tokens-Consumed" tokens-consumed-variable-name="tokensConsumed" />
            </inbound>
        </policies>
        """,
